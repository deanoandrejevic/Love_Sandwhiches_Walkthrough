...
def get_sales_data():
    ...
    via the terminal, which be a string of 6 numbers seperated
...
def update_worksheet(data, worksheet):
    """
    Receieves a list of intergers to be inserted into a worksheet
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defind as the sales figure subtracted from the stock:
    -Postive surplus indicates waste
    -Negative surplues indicates extra made when stock was sold out.
    """
...
def get_last_5_entries():
    """
    Retrieve the last 5 data entries from each sandwiches within the stock worksheet
    """
...
def calculate_stock_data(data):
    """
    Calculates the last 5 entries in the stock worksheet for each sandwich type
    """
